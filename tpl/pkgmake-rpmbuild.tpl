...
%files
%defattr(-,root,root)
%doc /usr/share/doc/pkgmake/pkgmake.txt
%doc /usr/share/doc/pkgmake/LICENSE
%doc /usr/share/doc/pkgmake/specfile.txt
%attr(755,root,root) %config /etc/pkgmake.conf
%attr(755,root,root) /usr/bin/pkgmake
/usr/share/man/man5/pkgmake.conf.5.gz
/usr/share/man/man5/pkgmake.tpl.5.gz
/usr/share/man/man8/pkgmake.8.gz
